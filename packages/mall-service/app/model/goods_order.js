...
module.exports = (app) => {
    ...
    const GoodsOrderLine = model.define(
        'goodsorderline',
    ...
    GoodsOrder.query = async ({
        ...
        const { count, rows: list } = await GoodsOrder.findAndCountAll(
            condition
        )
    ...
    GoodsOrder.saveModify = async (params) => {
        const { uuid, orgUuid, version, lastModifierId, lastModifierName } =
            params
